              ...
              <div class="col-xs-6 col-sm-8 col-md-9">
                  <div class="header-top_address">
                      <div class="header-top_list">
                          <span class="icon-phone"></span>+62813 2487 0720
                      </div>
                      <div class="header-top_list">
                          <span class="icon-envelope-open"></span>sekolahyakin@gmail.com
                      </div>
                      <div class="header-top_list">
                          <span class="icon-location-pin"></span>Tanjung Priok, DKI JAKARTA, INA.
                      </div>
                  </div>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="foot-logo">
                ...
                <p><?php echo date('Y');?> © copyright by <a href="" target="_blank">Kelompok 2 19.3A.07</a>. <br>All rights reserved.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="sitemap">
            ...
            <div class="col-md-3">
                <div class="address">
                    <h3>Hubungi Kami</h3>
                    <p><span>Alamat: </span> Tanjung Priok, DKI JAKARTA, INA.</p>
                    <p>Email : sekolahyakin@gmail.com
                        <br> Phone : +62813 2487 0720</p>
