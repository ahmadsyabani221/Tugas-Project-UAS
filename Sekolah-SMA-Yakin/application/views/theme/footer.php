<footer class="footer">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <img width="150" src="<?php echo base_url('');?>style/img/tut-wuri-handayani-7759.png" class="rounded" alt="">
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="" target="_blank">Kelompok 2 19.3A.07</a> </p>
                        </p>
                    </div>
                </div>
            </div>
